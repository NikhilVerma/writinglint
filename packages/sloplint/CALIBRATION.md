...
Sloplint keeps broad editorial recall without pretending every match is equally
...
Two local corpora were used as adversarial regression sets:

- 18 Markdown posts from `nikhil-verma-com/src/content/blog`
- 16 HTML pages from `stance-website-ds/blog`
...
A blind review was completed without looking at Sloplint output first. It found
