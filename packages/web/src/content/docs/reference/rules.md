...
description: Every rule in @better-write/rulepack-ai-style, grouped by category — the structural ones match over the dependency graph.
---

`@better-write/rulepack-ai-style` is the first rulepack. `recommended` enables every rule below at
