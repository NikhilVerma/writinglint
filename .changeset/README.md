...
that pull request is reviewed and merged, the publish workflow runs
automatically. Changesets publishes only versions not already on npm and creates
the corresponding package tags. Manual dispatch remains available as a recovery
path.
