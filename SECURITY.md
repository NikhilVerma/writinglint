...
WritingLint and SlopSift are pre-1.0 projects. Security fixes are applied to the
...
malicious files that escape SlopSift's intended local-file boundary. Ordinary
