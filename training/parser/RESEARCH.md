...
same EWT test split on the devbox; this is directional, not the eventual ONNX
microbenchmark.
...
Measured batched CPU graph execution on the devbox was approximately 0.7-0.8 ms
